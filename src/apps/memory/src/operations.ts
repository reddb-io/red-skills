...
const ReferenceRadarInputSchema = z.object({});
type ReferenceRadarInput = z.infer<typeof ReferenceRadarInputSchema>;
...
> = {
  ...
  inputSchema: ReferenceRadarInputSchema,
  outputSchema: ReferenceRadarOutputSchema,
  safetyClass: "read-only",
  sideEffectClass: "none",
  capabilities: ["graph-store"],
  renderer: {
