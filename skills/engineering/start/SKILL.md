...
### Update .red/CONTEXT.md inline

When a term is resolved, update `.red/CONTEXT.md` right there. Don't batch these up — capture them as they happen. Use the format in [CONTEXT-FORMAT.md](./CONTEXT-FORMAT.md).

`.red/CONTEXT.md` should be totally devoid of implementation details. Do not treat `.red/CONTEXT.md` as a spec, a scratch pad, or a repository for implementation decisions. It is a glossary and nothing else.
