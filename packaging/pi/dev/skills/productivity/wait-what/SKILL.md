...
Re-pitch the last reply with enough context to stand on its own.
Use ASD-STE100 Simplified Technical English. Write short sentences, one
instruction per sentence, and concrete words. Read `.red/CONTEXT-MAP.md`, find
the owning
