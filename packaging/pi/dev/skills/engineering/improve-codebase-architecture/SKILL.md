...
Classify the candidate's dependencies to decide how the deepened module is tested across its seam — in-process, local-substitutable, remote-but-owned, or true-external. See [DEEPENING.md](DEEPENING.md) for the categories, seam discipline, and the replace-don't-layer testing strategy.
