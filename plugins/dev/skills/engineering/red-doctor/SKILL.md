...
| `→ ADR 0092 doc-landing lane` | unlanded `.red/` docs (check 20) — land exactly one `docs:` PR from an isolated docs worktree, then merge it so `origin/{base}` carries the docs AFK workers need. |
