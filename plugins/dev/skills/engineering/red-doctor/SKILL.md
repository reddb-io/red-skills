...
| `→ operational probe registry` | red operational probes (check 21) — use the probe's own canonical fix. Adding a probe requires only its module plus one registry entry; doctor and fleet boot consume the registry generically. |
