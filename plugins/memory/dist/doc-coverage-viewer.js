export function buildDocCoverageViewerArtifact(report) {
    return {
        contract: {
...
function renderDocCoverageViewer(report) {
    const groundedPct = report.total_docs === 0
        ? "0%"
