...
import { buildProvenanceReport, findNodeForProvenance, } from "./provenance.js";
...
import { buildWhatifReport, } from "./whatif.js";
...
const CommunitiesViewerOutputSchema = objectOutputSchema();
const AskOutputSchema = objectOutputSchema();
const ReadinessOutputSchema = objectOutputSchema();
const ContextPackOutputSchema = objectOutputSchema();
const ContextPackViewerOutputSchema = objectOutputSchema();
const ClaimCheckOutputSchema = objectOutputSchema();
const DocBriefOutputSchema = objectOutputSchema();
const DocBriefViewerOutputSchema = objectOutputSchema();
const DocBundleOutputSchema = objectOutputSchema();
const DocBundleViewerOutputSchema = objectOutputSchema();
const DocReadOutputSchema = objectOutputSchema();
const DocEvidencePackOutputSchema = objectOutputSchema();
const DocEvidencePackViewerOutputSchema = objectOutputSchema();
const DocBacklinksOutputSchema = objectOutputSchema();
const DocBacklinksViewerOutputSchema = objectOutputSchema();
const DocRelatedOutputSchema = objectOutputSchema();
const DocRelatedViewerOutputSchema = objectOutputSchema();
const DocSearchOutputSchema = objectOutputSchema();
const DocCoverageOutputSchema = objectOutputSchema();
const SmartSearchOutputSchema = objectOutputSchema();
const SmartSearchViewerOutputSchema = objectOutputSchema();
const AssetInventoryOutputSchema = objectOutputSchema();
const AssetInventoryViewerOutputSchema = objectOutputSchema();
const CompetitiveEvalOutputSchema = objectOutputSchema();
const CompetitiveEvalViewerOutputSchema = objectOutputSchema();
const DocCoverageViewerOutputSchema = objectOutputSchema();
const DocReferenceGraphOutputSchema = objectOutputSchema();
const DocReferenceGraphViewerOutputSchema = objectOutputSchema();
const DocSearchViewerOutputSchema = objectOutputSchema();
const PrePrReviewOutputSchema = objectOutputSchema();
const PrePrReviewViewerOutputSchema = objectOutputSchema();
const ProvenanceOutputSchema = objectOutputSchema();
const PrivacyOutputSchema = objectOutputSchema();
const LintOutputSchema = objectOutputSchema();
const SkillRecommendationsOutputSchema = objectOutputSchema();
const LearningDebtOutputSchema = objectOutputSchema();
const LearningDebtViewerOutputSchema = objectOutputSchema();
const MemoryLayersOutputSchema = objectOutputSchema();
const MemoryLayersViewerOutputSchema = objectOutputSchema();
const OnboardingMapOutputSchema = objectOutputSchema();
const OnboardingMapViewerOutputSchema = objectOutputSchema();
const DashboardOutputSchema = objectOutputSchema();
const WorkbenchOutputSchema = objectOutputSchema();
const ReadinessViewerOutputSchema = objectOutputSchema();
const RoutingGuideOutputSchema = objectOutputSchema();
const RoutingGuideViewerOutputSchema = objectOutputSchema();
const AgentIntegrationStatusOutputSchema = objectOutputSchema();
const AgentIntegrationStatusViewerOutputSchema = objectOutputSchema();
const SessionTimelineOutputSchema = objectOutputSchema();
const SessionTimelineViewerOutputSchema = objectOutputSchema();
const PathExplainOutputSchema = objectOutputSchema();
const ConfidenceOutputSchema = objectOutputSchema();
const PathExplainViewerOutputSchema = objectOutputSchema();
const StructuralImpactOutputSchema = objectOutputSchema();
const StructuralImpactViewerOutputSchema = objectOutputSchema();
const ExtractionStatusOutputSchema = objectOutputSchema();
const ExtractionStatusViewerOutputSchema = objectOutputSchema();
const VectorStatusOutputSchema = objectOutputSchema();
const VectorStatusViewerOutputSchema = objectOutputSchema();
const VectorSearchOutputSchema = objectOutputSchema();
const ReasoningReplayOutputSchema = objectOutputSchema();
const FederationOutputSchema = objectOutputSchema();
const WhatifOutputSchema = objectOutputSchema();
const HealthOutputSchema = objectOutputSchema();
const HealthViewerOutputSchema = objectOutputSchema();
const MemoryDecayOutputSchema = objectOutputSchema();
const MemoryDecayViewerOutputSchema = objectOutputSchema();
const GovernanceOutputSchema = objectOutputSchema();
const GovernanceViewerOutputSchema = objectOutputSchema();
const HandoffOutputSchema = objectOutputSchema();
const HandoffViewerOutputSchema = objectOutputSchema();
const WorkFrontierOutputSchema = objectOutputSchema();
const WorkFrontierViewerOutputSchema = objectOutputSchema();
const HookCoverageOutputSchema = objectOutputSchema();
const HookCoverageViewerOutputSchema = objectOutputSchema();
const CapabilityCatalogOutputSchema = objectOutputSchema();
const CompetitiveRadarOutputSchema = objectOutputSchema();
const ASK_OPERATION = {
    id: "memory.ask",
    title: "Evidence-backed Memory ask",
    description: "Grounded ASK over Memory evidence with citations, gap analysis, and provider cost metadata.",
    ...
    renderer: {
        ...
        mcp: {
            toolName: "memory_ask",
            description: "Read-only evidence-backed ASK over Memory evidence. Returns grounded answer status, citations, active/superseded/contradictory evidence, gap analysis, and provider cost metadata when available.",
        },
    },
    execute: (ctx, input) => ask(ctx.store, input.question, { rootDir: ctx.rootDir }),
};
const ASSET_INVENTORY_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only inventory of binary document/media assets indexed by memory ingest. Returns asset kind, media type, size, hash, rid, and source path without reading binary bodies or claiming OCR/transcripts.",
        },
    },
    execute: (ctx, input) => buildMemoryAssetInventory(ctx.store, input),
};
const ASSET_INVENTORY_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for indexed binary document/media assets. Returns embedded JSON and HTML without reading asset bodies.",
        },
    },
    execute: async (ctx, input) => buildMemoryAssetInventoryViewerArtifact(await buildMemoryAssetInventory(ctx.store, input)),
};
const READINESS_OPERATION = {
    id: "memory.readiness",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only Memory readiness envelope (memory.readiness.v1) for a goal, including evidence, retrieval, trust, privacy, claim-check, skill, learning-debt, and next-action signals.",
        },
    },
    execute: (ctx, input) => buildReadinessEnvelope(ctx.store, input.goal, {
        limit: input.limit,
...
const CONTEXT_PACK_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only agent context pack for a goal. Returns grouped evidence, warnings, citations, markdown, and skill recommendations without writing graph facts.",
        },
    },
    execute: (ctx, input) => buildContextPack(ctx.store, input.goal, {
...
const CONTEXT_PACK_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for agent context packs. Returns grouped evidence, warnings, citations, skill recommendations, ready-to-inject markdown, embedded JSON, and HTML.",
        },
    },
    execute: async (ctx, input) => buildContextPackViewerArtifact(await buildContextPack(ctx.store, input.goal, {
        budgetChars: input.budget_chars,
        limit: input.limit,
        depth: input.depth,
        scope: scopeFromInput(input),
...
const CLAIM_CHECK_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only claim-check against local Memory evidence. Returns supported/contradicted/superseded/insufficient status with citations and conflicting evidence.",
        },
    },
    execute: (ctx, input) => claimCheck(ctx.store, input.assertion),
};
const CAPABILITY_CATALOG_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only capability catalog. Groups Memory features across retrieval, docs, vectors, UI, hooks, code graph, governance, telemetry, and interop with CLI/MCP entry points and competitive evidence IDs.",
        },
    },
    execute: (ctx) => buildMemoryCapabilityCatalog(ctx.store, ctx.rootDir ?? process.cwd()),
};
const COMPETITIVE_RADAR_OPERATION = {
    id: "memory.competitive-radar",
    title: "Memory competitive radar",
    description: "Read-only internal competitor posture report derived from the Memory capability catalog.",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only internal competitive radar. Maps capability catalog evidence to named competitor axes, highlights degraded/not-configured gaps, and returns next actions without making public benchmark claims.",
        },
    },
    execute: (ctx) => buildMemoryCompetitiveRadar(ctx.store, ctx.rootDir ?? process.cwd()),
};
const COMPETITIVE_EVAL_OPERATION = {
    id: "memory.competitive-eval",
    title: "Memory competitive eval",
    description: "Read-only executable competitive eval v2 report over checked-in Memory moat fixtures.",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only executable competitive eval v2 report. Returns dimensions, claim guards, checked fixture metrics, and opt-in live baseline slots without requiring live services.",
        },
    },
    execute: () => evaluateCompetitiveEvalV2({ now: Date.now() }),
};
const COMPETITIVE_EVAL_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for competitive eval v2. Returns dimensions, metrics, claim guards, embedded JSON, and HTML.",
        },
    },
    execute: async () => buildCompetitiveEvalViewerArtifact(await evaluateCompetitiveEvalV2({ now: Date.now() })),
};
const HANDOFF_OPERATION = {
    id: "memory.handoff",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only cross-agent handoff brief. Returns active work, recent decisions, validation evidence, risks, relevant context, citations, and ready-to-inject markdown without reading raw transcripts or mutating Memory.",
        },
    },
    execute: (ctx, input) => buildMemoryHandoff(ctx.store, {
        focus: input.focus,
        limit: input.limit,
    }),
};
const HANDOFF_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for cross-agent Memory handoffs. Returns active work, decisions, validations, risks, context, ready-to-inject markdown, embedded JSON, and HTML.",
        },
    },
    execute: async (ctx, input) => buildMemoryHandoffViewerArtifact(await buildMemoryHandoff(ctx.store, {
        focus: input.focus,
        limit: input.limit,
    })),
};
const WORK_FRONTIER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only work frontier over Memory task/goal/issue/PRD evidence. Returns ready, blocked, completed, dependency blockers, priorities, citations, markdown, and next actions without mutating work state.",
        },
    },
    execute: (ctx, input) => buildWorkFrontier(ctx.store, {
        focus: input.focus,
        limit: input.limit,
    }),
};
const WORK_FRONTIER_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for ready/blocked Memory work. Returns priorities, blockers, citations, markdown, embedded JSON, and HTML without mutating work state.",
        },
    },
    execute: async (ctx, input) => buildWorkFrontierViewerArtifact(await buildWorkFrontier(ctx.store, {
        focus: input.focus,
        limit: input.limit,
    })),
};
const CONFIDENCE_OPERATION = {
    id: "memory.confidence",
    title: "Memory confidence breakdown",
    description: "Read-only composed confidence (0..1) plus per-signal breakdown for a Memory node (issue #167).",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only composed confidence breakdown for a Memory node. Returns the [0,1] score, per-signal components (provenance, recency, supersession, validation), and raw signals.",
        },
    },
    execute: async (ctx, input) => {
        const report = await buildConfidenceReport(ctx.store, input.node);
        if (!report)
            throw new Error(`memory: no node with rid=${input.node}`);
        return report;
    },
};
const PATH_EXPLAIN_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only explained graph path between two Memory labels. Returns reachable status, hop count, node sequence, edge labels, citations, and markdown for agent reasoning.",
        },
    },
    execute: (ctx, input) => buildPathExplainReport(ctx.store, {
        from: input.from,
        to: input.to,
        maxDepth: input.max_depth,
    }),
};
const PATH_EXPLAIN_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for a Memory graph path explanation. Returns path nodes, edge labels, recommendations, embedded JSON, and HTML without writing a file.",
        },
    },
    execute: async (ctx, input) => buildPathExplainViewerArtifact(await buildPathExplainReport(ctx.store, {
        from: input.from,
        to: input.to,
        maxDepth: input.max_depth,
    })),
};
const DOC_SEARCH_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only zero-token search over ingested memory_docs chunks. Returns matching document paths, titles, short excerpts, matched fields, and scores without calling an LLM.",
        },
    },
    execute: (ctx, input) => searchDocs(ctx.store, input.query, { limit: input.limit }),
};
const DOC_SEARCH_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for ingested docs search results. Returns embedded JSON and links to read, brief, bundle, and evidence-pack viewers.",
        },
    },
    execute: async (ctx, input) => buildDocSearchViewerArtifact(await searchDocs(ctx.store, input.query, { limit: input.limit })),
};
const DOC_BUNDLE_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only agent-ready documentation bundle for a query. Searches ingested memory_docs, builds evidence packs for top hits, and returns consolidated markdown without calling an LLM.",
        },
    },
    execute: (ctx, input) => buildDocBundle(ctx.store, input),
};
const DOC_BRIEF_OPERATION = {
    id: "memory.doc-brief",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only citation-first brief over ingested memory_docs. Searches docs, composes bundle evidence, emits [D#] citations, gaps, next actions, and ready-to-inject markdown without calling an LLM.",
        },
    },
    execute: (ctx, input) => buildDocBrief(ctx.store, input),
};
const DOC_BRIEF_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for a citation-first documentation brief. Returns embedded JSON, [D#] citations, gaps, next actions, and ready-to-inject markdown.",
        },
    },
    execute: async (ctx, input) => buildDocBriefViewerArtifact(await buildDocBrief(ctx.store, input)),
};
const DOC_BUNDLE_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for a query-level documentation bundle. Searches ingested memory_docs, builds evidence packs for top hits, and returns embedded JSON plus agent-ready markdown.",
        },
    },
    execute: async (ctx, input) => buildDocBundleViewerArtifact(await buildDocBundle(ctx.store, input)),
};
const DOC_READ_OPERATION = {
    id: "memory.doc-read",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only access to an ingested memory_docs chunk by path or rid. Returns body text, metadata, and truncation status without calling an LLM.",
        },
    },
    execute: (ctx, input) => readDoc(ctx.store, input),
};
const DOC_EVIDENCE_PACK_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only agent-ready context pack for one ingested memory_docs chunk. Returns the indexed body, extracted REFERENCES, related docs, warnings, and ready-to-inject markdown.",
        },
    },
    execute: (ctx, input) => buildDocEvidencePack(ctx.store, input),
};
const DOC_EVIDENCE_PACK_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for one ingested doc evidence pack. Returns embedded JSON, indexed body markdown, extracted references, related docs, and warnings.",
        },
    },
    execute: async (ctx, input) => buildDocEvidencePackViewerArtifact(await buildDocEvidencePack(ctx.store, input)),
};
const DOC_BACKLINKS_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only inverse documentation reference report. Given a referenced node rid, label, title, or query, returns ingested memory_docs chunks that point at it through extracted REFERENCES edges.",
        },
    },
    execute: (ctx, input) => buildDocBacklinksReport(ctx.store, input),
};
const DOC_BACKLINKS_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for inverse documentation references. Given a referenced node rid, label, title, or query, returns embedded JSON and HTML for docs pointing at it.",
        },
    },
    execute: async (ctx, input) => buildDocBacklinksViewerArtifact(await buildDocBacklinksReport(ctx.store, input)),
};
const DOC_RELATED_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only related-document report for an ingested memory_docs chunk by path or rid. Returns extracted references and other docs that share those references.",
        },
    },
    execute: (ctx, input) => buildDocRelatedReport(ctx.store, input),
};
const DOC_RELATED_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for one ingested doc's extracted references and related docs. Returns embedded JSON and HTML without writing Memory.",
        },
    },
    execute: async (ctx, input) => buildDocRelatedViewerArtifact(await buildDocRelatedReport(ctx.store, input)),
};
const SMART_SEARCH_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only smart search over Memory. Composes governed recall, ingested document search, and vector diagnostics into one result without making vector search the source of truth.",
        },
    },
    execute: (ctx, input) => buildMemorySmartSearch(ctx.store, input.query, {
        limit: input.limit,
        depth: input.depth,
        recall: {
            scope: scopeFromInput(input),
...
const SMART_SEARCH_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for smart search. Returns fused recall/doc/asset/vector results, counts, recommendations, embedded JSON, and HTML without writing Memory.",
        },
    },
    execute: async (ctx, input) => buildMemorySmartSearchViewerArtifact(await buildMemorySmartSearch(ctx.store, input.query, {
        limit: input.limit,
        depth: input.depth,
        recall: {
            scope: scopeFromInput(input),
...
const DOC_COVERAGE_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only coverage report for ingested memory_docs chunks. Returns graph grounding, extracted REFERENCES coverage, vector projection status, document byte sizes, and warnings.",
        },
    },
    execute: (ctx) => buildDocCoverageReport(ctx.store),
};
const DOC_COVERAGE_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for ingested document coverage. Returns graph grounding, extracted references, vector coverage, warnings, embedded JSON, and HTML without writing a file.",
        },
    },
    execute: async (ctx) => buildDocCoverageViewerArtifact(await buildDocCoverageReport(ctx.store)),
};
const DOC_REFERENCE_GRAPH_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only graph of ingested memory_docs chunks and extracted REFERENCES edges. Returns doc nodes, referenced entity nodes, top references, graph edges, grounding counts, and warnings without mutating Memory.",
        },
    },
    execute: (ctx) => buildDocReferenceGraphReport(ctx.store),
};
const DOC_REFERENCE_GRAPH_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for the documentation reference graph. Returns doc/reference nodes, REFERENCES edges, top references, embedded JSON, and HTML without writing Memory.",
        },
    },
    execute: async (ctx) => buildDocReferenceGraphViewerArtifact(await buildDocReferenceGraphReport(ctx.store)),
};
const PRE_PR_REVIEW_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only pre-PR review over explicit changed files. Returns impacted concepts, related decisions, known failures, suggested validations, risks, and evidence markers without invoking git or mutating Memory.",
        },
    },
    execute: (ctx, input) => buildPrePrMemoryReview(ctx.store, {
        changedFiles: input.changed_files,
        comparison: input.comparison,
    }),
};
const PRE_PR_REVIEW_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML pre-PR review viewer. Returns impacted concepts, related decisions, failures, validations, risks, evidence, and embedded JSON without invoking git or writing a file.",
        },
    },
    execute: async (ctx, input) => buildPrePrReviewViewerArtifact(await buildPrePrMemoryReview(ctx.store, {
        changedFiles: input.changed_files,
        comparison: input.comparison,
    })),
};
const PROVENANCE_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only provenance audit for a Memory node by rid or label. Returns writer, source kind, scope, timestamps, confidence, and evidence references.",
        },
    },
    execute: async (ctx, input) => {
        const node = await findNodeForProvenance(ctx.store, input.target);
        if (!node)
            throw new Error(`memory provenance target not found: ${input.target}`);
        return buildProvenanceReport(node);
    },
};
const PRIVACY_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only privacy scan over graph Memory nodes and edges. Returns sensitive-looking findings and never writes redacted exports or graph updates.",
        },
    },
    execute: async (ctx) => {
...
const GOVERNANCE_OPERATION = {
    id: "memory.governance",
    title: "Memory governance",
    description: "Read-only governance report over provenance, privacy, lint, contradictions, and supersession.",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only governance report over local Memory evidence. Returns provenance coverage, privacy findings, lint findings, contradiction/supersession counts, and recommended next actions without mutating Memory.",
        },
    },
    execute: (ctx, input) => buildMemoryGovernanceReport(ctx.store, {
        staleProgressDays: input.stale_progress_days,
    }),
};
const GOVERNANCE_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for provenance, privacy, lint, contradictions, supersession, recommended actions, and embedded governance JSON.",
        },
    },
    execute: async (ctx, input) => buildMemoryGovernanceViewerArtifact(await buildMemoryGovernanceReport(ctx.store, {
        staleProgressDays: input.stale_progress_days,
    })),
};
const LINT_OPERATION = {
    id: "memory.lint",
    title: "Memory lint",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only policy hygiene lint over graph Memory nodes. Returns stale-progress, imperative-memory, missing-scope/tier, duplicate-like, and likely-secret findings.",
        },
    },
    execute: async (ctx, input) => {
...
const SKILL_RECOMMENDATIONS_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only RedSkills recommendations for a task from Memory evidence and skill telemetry rollups. Returns ranked recommendations, reasons, citations, and missing evidence.",
        },
    },
    execute: async (ctx, input) => buildSkillRecommendations(ctx.store, input.task, {
        limit: input.limit,
        depth: input.depth,
        scope: scopeFromInput(input),
...
const LEARNING_DEBT_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only learning debt report: repeated failure patterns, stale or contradicted guidance, missing validation evidence, and Skill telemetry gaps.",
        },
    },
    execute: async (ctx, input) => buildLearningDebtReport(ctx.store, {
        staleDays: input.stale_days,
...
const LEARNING_DEBT_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for Memory learning debt: repeated failure patterns, stale or contradicted guidance, missing validation evidence, Skill telemetry gaps, embedded JSON, and agent markdown.",
        },
    },
    execute: async (ctx, input) => buildLearningDebtViewerArtifact(await buildLearningDebtReport(ctx.store, {
        staleDays: input.stale_days,
        minRepeatedFailures: input.min_repeated_failures,
        rollups: await safeSkillRollups(ctx.store),
        skillTelemetryEnabled: true,
...
const MEMORY_LAYERS_OPERATION = {
    id: "memory.layers",
    title: "Memory layers",
    description: "Read-only layered Memory architecture report over session, durable, reasoning, docs/code, and vector evidence.",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only Memory layers report. Summarizes short-term session events, long-term durable graph facts, reasoning traces, docs/code graph evidence, and vector projection over the embedded RedDB store.",
        },
    },
    execute: (ctx) => buildMemoryLayersReport(ctx.store),
};
const MEMORY_LAYERS_VIEWER_OPERATION = {
    id: "memory.layers-viewer",
    title: "Memory layers viewer",
    description: "Self-contained HTML viewer for layered Memory architecture over RedDB evidence.",
    inputSchema: MemoryLayersInputSchema,
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for Memory layers. Returns short-term, long-term, reasoning, docs/code, and vector layer readiness, competitor alignment, recommended actions, embedded JSON, and HTML.",
        },
    },
    execute: async (ctx) => buildMemoryLayersViewerArtifact(await buildMemoryLayersReport(ctx.store)),
};
const HEALTH_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only Memory health summary for MCP agents. Returns graph stats, vector readiness, stale-node diagnostics, Skill telemetry availability, and recommended next actions.",
        },
    },
    execute: (ctx, input) => buildMemoryHealthReport(ctx.store, input),
};
const HEALTH_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for Memory health. Returns graph stats, vector readiness, stale-node diagnostics, Skill telemetry availability, recommended actions, embedded JSON, and HTML.",
        },
    },
    execute: async (ctx, input) => buildMemoryHealthViewerArtifact(await buildMemoryHealthReport(ctx.store, input)),
};
const MEMORY_DECAY_OPERATION = {
    id: "memory.decay",
    title: "Memory decay plan",
    description: "Read-only retention planner over Memory nodes, access evidence, supersession, contradictions, and TTL horizons.",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only Memory decay/retention plan. Classifies nodes as keep, review, deprecate, or expire using access evidence, stale thresholds, supersession, contradictions, TTL horizons, and pinned importance without deleting anything.",
        },
    },
    execute: (ctx, input) => buildMemoryDecayReport(ctx.store, input),
};
const MEMORY_DECAY_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for Memory decay planning. Returns keep/review/deprecate/expire sections, recommendations, embedded JSON, and HTML without mutating Memory.",
        },
    },
    execute: async (ctx, input) => buildMemoryDecayViewerArtifact(await buildMemoryDecayReport(ctx.store, input)),
};
const HOOK_COVERAGE_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only hook coverage report. Returns Claude/Codex hook manifest wiring, config-enabled lifecycle events, known runner gaps such as Codex PreCompact absence, and recommended next actions without enabling hooks.",
        },
    },
    execute: (ctx) => buildHookCoverageReport(ctx.rootDir ?? process.cwd()),
};
const HOOK_COVERAGE_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for hook coverage. Returns Claude/Codex manifest wiring, enabled/effective lifecycle events, gaps, recommended actions, embedded JSON, and HTML without enabling hooks.",
        },
    },
    execute: async (ctx) => buildHookCoverageViewerArtifact(await buildHookCoverageReport(ctx.rootDir ?? process.cwd())),
};
const COMMUNITIES_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only Memory graph community analytics: native Louvain assignments, community counts, top labels/titles, and graph-hash cache metadata. Does not write derived clusters into Memory graph evidence.",
        },
    },
    execute: (ctx, input) => buildCommunityAnalytics(ctx.store, { cache: input.cache }),
};
const COMMUNITIES_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for RedDB graph community analytics. Returns native Louvain community summaries, assignments, cache metadata, embedded JSON, and HTML without writing derived clusters into Memory evidence.",
        },
    },
    execute: async (ctx, input) => buildCommunitiesViewerArtifact(await buildCommunityAnalytics(ctx.store, { cache: input.cache })),
};
const ONBOARDING_MAP_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only map-first onboarding summary from Memory graph evidence. Returns concepts, workflows, decisions, risks, validations, suggested skills, warnings, and markdown.",
        },
    },
    execute: async (ctx, input) => buildOnboardingMap(ctx.store, {
        staleDays: input.stale_days,
        rollups: await safeSkillRollups(ctx.store),
    }),
};
const ONBOARDING_MAP_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for Memory onboarding maps. Returns concepts, workflows, decisions, risks, validations, suggested skills, warnings, embedded JSON, and HTML.",
        },
    },
    execute: async (ctx, input) => buildOnboardingMapViewerArtifact(await buildOnboardingMap(ctx.store, {
        staleDays: input.stale_days,
        rollups: await safeSkillRollups(ctx.store),
    })),
};
const DASHBOARD_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained operational dashboard. Returns graph stats, document coverage, vector readiness, hook coverage, stale-node summary, recommendations, embedded JSON, and HTML without writing a file.",
        },
    },
    execute: async (ctx, input) => buildMemoryOperationalDashboardArtifact(await buildMemoryOperationalDashboard(ctx.store, ctx.rootDir ?? process.cwd(), {
        staleDays: input.stale_days,
    })),
};
const WORKBENCH_OPERATION = {
    id: "memory.workbench",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained Memory workbench. Returns a unified local UI over operational dashboard, capability catalog, session timeline replay evidence, embedded JSON, and HTML without writing a file.",
        },
    },
    execute: async (ctx, input) => buildMemoryWorkbenchArtifact(await buildMemoryWorkbench(ctx.store, ctx.rootDir ?? process.cwd(), {
        staleDays: input.stale_days,
        sessionId: input.session_id,
        limit: input.limit,
    })),
};
const READINESS_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML readiness viewer. Returns the memory.readiness.viewer.v1 artifact, embedded readiness envelope, and HTML without writing a file.",
        },
    },
    execute: async (ctx, input) => buildReadinessViewerArtifact(await buildReadinessEnvelope(ctx.store, input.goal, {
        limit: input.limit,
        minEvidence: input.min_evidence,
        staleDays: input.stale_days,
        scope: scopeFromInput(input),
...
const ROUTING_GUIDE_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only Memory routing guide for agent rule files. Returns target files, recommended MCP tools, CLI fallbacks, safety notes, and an installable AGENTS.md/CLAUDE.md snippet.",
        },
    },
    execute: async (_ctx, input) => buildMemoryRoutingGuide({ agent: input.agent }),
};
const ROUTING_GUIDE_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML Memory routing guide viewer. Returns target files, recommended MCP tools, CLI fallbacks, safety notes, config snippets, and embedded JSON for a selected agent.",
        },
    },
    execute: async (_ctx, input) => buildMemoryRoutingGuideViewerArtifact(buildMemoryRoutingGuide({ agent: input.agent })),
};
const AGENT_INTEGRATION_STATUS_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only Memory agent integration status. Audits rule files, routing snippets, MCP/HTTP guidance, and hook coverage for supported agents.",
        },
    },
    execute: (ctx, input) => buildMemoryAgentIntegrationStatus(ctx.rootDir ?? process.cwd(), {
        agent: input.agent,
    }),
};
const AGENT_INTEGRATION_STATUS_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for Memory agent integration status with embedded JSON.",
        },
    },
    execute: async (ctx, input) => buildMemoryAgentIntegrationStatusViewerArtifact(await buildMemoryAgentIntegrationStatus(ctx.rootDir ?? process.cwd(), {
        agent: input.agent,
    })),
};
const SESSION_TIMELINE_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only replay-style timeline over Memory session events. Returns hook lifecycle events, skill telemetry, per-session summaries, outcomes, and next actions without exposing raw transcripts.",
        },
    },
    execute: (ctx, input) => buildSessionTimeline(ctx.store, {
        sessionId: input.session_id,
        limit: input.limit,
    }),
};
const SESSION_TIMELINE_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML session timeline viewer. Returns hook lifecycle events, skill telemetry, per-session summaries, outcomes, and embedded JSON without exposing raw transcripts.",
        },
    },
    execute: async (ctx, input) => buildSessionTimelineViewerArtifact(await buildSessionTimeline(ctx.store, {
        sessionId: input.session_id,
        limit: input.limit,
    })),
};
const STRUCTURAL_IMPACT_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only file/symbol impact query over ingested code graph evidence. Returns imports, imported-by edges, call/called-by edges, type-use edges, symbols defined by a file, and the file defining a symbol.",
        },
    },
    execute: (ctx, input) => structuralImpactReader(ctx.store)({
        file: input.file,
        symbol: input.symbol,
    }),
};
const STRUCTURAL_IMPACT_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for file/symbol impact. Returns imports, call edges, type-use edges, definitions, and embedded JSON without writing a file.",
        },
    },
    execute: async (ctx, input) => buildStructuralImpactViewerArtifact({ file: input.file, symbol: input.symbol }, await structuralImpactReader(ctx.store)({
        file: input.file,
        symbol: input.symbol,
    })),
};
const EXTRACTION_STATUS_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only status for Memory extraction. Returns deterministic extractor availability, local structured-transcript fallback readiness, inferred provider mode/model/egress, Stop hook readiness, inferred fact count, and next actions.",
        },
    },
    execute: (ctx) => buildMemoryExtractionStatus(ctx.store, ctx.rootDir ?? process.cwd()),
};
const EXTRACTION_STATUS_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for extraction readiness. Returns deterministic extractor coverage, inferred provider status, Stop hook readiness, inferred fact counts, next actions, embedded JSON, and HTML without running extraction.",
        },
    },
    execute: async (ctx) => buildMemoryExtractionStatusViewerArtifact(await buildMemoryExtractionStatus(ctx.store, ctx.rootDir ?? process.cwd())),
};
const VECTOR_STATUS_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only vector projection readiness for hybrid recall. Returns ready/stale/unavailable/failed counts for provider embeddings or opt-in local-dev vectors.",
        },
    },
    execute: (ctx) => ctx.store.vectorStatus(),
};
const VECTOR_STATUS_VIEWER_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only self-contained HTML viewer for RedDB vector projection readiness. Returns ready/stale/unavailable/failed counts, node and document target statuses, embedded JSON, and HTML without maintaining embeddings.",
        },
    },
    execute: async (ctx) => buildVectorStatusViewerArtifact(await ctx.store.vectorStatus()),
};
const VECTOR_SEARCH_OPERATION = {
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only diagnostic search over grounded vector candidates. Returns vector-backed Memory node hits, scores, confidence, and excerpts, or an unavailable status when vector projection is not ready. Set RED_MEMORY_VECTOR_PROVIDER=local for deterministic local-dev vectors. Governed recall remains memory_recall.",
        },
    },
    execute: (ctx, input) => buildVectorSearchReport(ctx.store, input.query, { limit: input.limit }),
};
const REASONING_REPLAY_OPERATION = {
    id: "memory.reasoning-replay",
    title: "Memory reasoning replay",
    description: "Read-only similarity ranking over reasoning-tier attempt nodes for a task descriptor.",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only reasoning replay surface. Ranks past attempt nodes by semantic similarity to a task descriptor and returns top-K with attempt_id, similarity, when, and summary. Outcome attachment lands in a follow-up slice.",
        },
    },
    execute: (ctx, input) => buildReasoningReplay(ctx.store, input.task, { limit: input.limit }),
};
const WHATIF_OPERATION = {
    id: "memory.whatif",
    title: "Memory what-if (pre-action blast radius)",
    description: "Read-only pre-action blast-radius prediction. Composes structural-impact-reader and reasoning-replay to return affected files, symbols, tests, historical similar attempts, a composite breakage_likelihood, and a self_confidence score.",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only what-if surface (memory.whatif.v1). Accepts a list of proposed changes (rename/delete/edit, each with file/symbol/with/description) and returns predicted blast radius: affected.files, affected.symbols, affected.tests, historical_attempts from reasoning-replay, breakage_likelihood in [0,1], and self_confidence in [0,1]. Never mutates state.",
        },
    },
    execute: (ctx, input) => buildWhatifReport(ctx.store, input.changes, { limit: input.limit }),
};
const FEDERATION_OPERATION = {
    id: "memory.federation",
    title: "Memory federation",
    description: "Read-only cross-root federation. Reads memory notes from each configured root in .red/memory/federation.yaml and returns merged hits tagged with origin_repo. No privacy policy applied in this slice.",
    ...
    renderer: {
        ...
        mcp: {
            ...
            description: "Read-only federation surface. Reads memory notes from every root listed in .red/memory/federation.yaml at the active project root, merges hits, and tags each with origin_repo. Returns an empty report when no config exists. Local roots only in this slice.",
        },
    },
    execute: (ctx, input) => buildFederationReport(ctx.rootDir ?? process.cwd(), input.query, {
        limit: input.limit,
...
export function createReadOnlyMemoryOperationRegistry(operations) {
    const byId = new Map();
    for (const operation of operations) {
        assertReadOnlyOperation(operation);
        if (byId.has(operation.id))
            throw new Error(`duplicate Memory operation: ${operation.id}`);
    ...
    return {
        ...
        get: (id) => {
            ...
            if (!operation)
                throw new Error(`unknown read-only Memory operation: ${id}`);
            return operation;
        },
...
export function listReadOnlyMemoryOperations() {
    return READ_ONLY_OPERATIONS.list();
}
export function getReadOnlyMemoryOperation(id) {
    return READ_ONLY_OPERATIONS.get(id);
}
export async function executeReadOnlyMemoryOperation(id, ctx, input) {
...
function objectOutputSchema() {
    return z.custom((value) => value !== null && typeof value === "object");
}
...
async function safeSkillRollups(store) {
    try {
...
async function graphPrivacyRecords(store) {
...
function parseScope(value) {
    return MEMORY_SCOPES.includes(value) ? value : undefined;
}
