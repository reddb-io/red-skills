export function buildMemoryGovernanceViewerArtifact(report) {
    return {
        contract: {
...
function renderMemoryGovernanceViewer(report) {
    return `<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
function signal(title, detail, status) {
...
function findingItem(category, code, message, location, severity) {
