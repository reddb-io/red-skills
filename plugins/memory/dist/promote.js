...
function candidateTypeToNodeType(eventType) {
...
function l2EventNodes(nodes, session_id) {
    const out = [];
 ...
 */
export async function runPromote(store, rootDir, opts = {}) {
...
async function emitPromoteEvent(store, input) {
