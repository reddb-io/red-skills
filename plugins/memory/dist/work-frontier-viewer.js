export function buildWorkFrontierViewerArtifact(report) {
    return {
        contract: {
...
function renderWorkFrontierViewer(report) {
    return `<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
function itemsSection(title, items, empty) {
    return `<section>
...
function itemHtml(item) {
    const blockers = item.blocked_by.length === 0
        ? ""
