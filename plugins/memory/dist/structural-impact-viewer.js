export function buildStructuralImpactViewerArtifact(target, impact) {
    return {
        contract: {
...
function renderStructuralImpactViewer(target, impact) {
...
function nodeSection(title, nodes) {
    return `<section>
...
function edgeSection(title, edges, focus) {
    return `<section>
    <h2>${escapeHtml(title)}</h2>
    ${edges.length === 0
...
function definedInSection(impact) {
