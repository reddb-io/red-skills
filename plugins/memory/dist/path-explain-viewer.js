export function buildPathExplainViewerArtifact(report) {
    return {
        contract: {
...
function renderPathExplainViewer(report) {
    return `<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
function requestSection(report) {
    return `<section>
    <h2>Request</h2>
    <ul>
...
function nextActionsSection(report) {
    return `<section>
    <h2>Next Actions</h2>
