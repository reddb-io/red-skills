export function buildLearningDebtViewerArtifact(report) {
    return {
        contract: {
...
function renderLearningDebtViewer(report) {
    const totalDebt = report.summary.repeatedFailurePatterns +
...
function repeatedFailureItem(item) {
    return `<li>
    <div>
