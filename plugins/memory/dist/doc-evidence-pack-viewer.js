export function buildDocEvidencePackViewerArtifact(pack) {
    return {
        contract: {
...
function renderDocEvidencePackViewer(pack) {
...
function referencesSection(pack) {
    return `<section>
    <h2>References</h2>
...
function relatedDocsSection(pack) {
    return `<section>
    <h2>Related Docs</h2>
