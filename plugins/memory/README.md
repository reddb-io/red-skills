...
| **[improve-skills](./skills/core/improve-skills/SKILL.md)** | Generate approval-gated Skill improvement proposals from telemetry; writes `.red/memory/proposals/*.md` only when explicitly requested. |
