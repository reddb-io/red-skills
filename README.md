...
| **[improve-skills](./plugins/memory/skills/core/improve-skills/SKILL.md)** | `/memory:improve-skills` — generate approval-gated Skill improvement proposals from telemetry; writes `.red/memory/proposals/*.md` only when explicitly requested. |
