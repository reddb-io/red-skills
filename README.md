...
| [`verify-browser`](./plugins/dev/skills/engineering/verify-browser/SKILL.md)                       | Confirm a UI claim against a fresh a11y-tree snapshot before reporting success (chrome-devtools-axi). |
