...
- **what changed**:
  ...
  - `plugins/dev/skills/engineering/afk/examples/red-skills-afk-attempt.yml` (NEW): thin caller template for adopters who want explicit control over the trigger and allowlist in their own repo. ~50 lines, copies verbatim, edits 2 allowlist values.
