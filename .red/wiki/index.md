...
- [feat(afk): atomic GitHub-native claim — pure reconciler over server-ordered claim comments (#622)](./pages/730-feat-afk-atomic-github-native-claim-pure-reconciler-over-ser.md)
...
- [feat(afk): cross-host stale-claim recovery — a dead worker's claim no longer blocks the queue](./pages/736-feat-afk-cross-host-stale-claim-recovery-a-dead-worker-s-cla.md)
...
- [feat(afk): trust gate — executable-issue check over author × label-actor × allowlist (#621)](./pages/734-feat-afk-trust-gate-executable-issue-check-over-author-label.md)
...
- [fix(afk): init the red-castle submodule in the feedback-gate worktree (landing blocker)](./pages/720-fix-afk-init-the-red-castle-submodule-in-the-feedback-gate-w.md)
...
- [fix(afk): seed attempt state synchronously so the worker's identity survives (monitor/statusline ghost)](./pages/721-fix-afk-seed-attempt-state-synchronously-so-the-worker-s-ide.md)
...
- [fix(statusline): anchor to the session project_dir, not the live cwd](./pages/718-fix-statusline-anchor-to-the-session-project-dir-not-the-liv.md)
