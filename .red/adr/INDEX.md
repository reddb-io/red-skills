...
- **0097** AFK Docs Sweep enforces origin-visible docs before worker dispatch — successor of 0092; `/afk` detects stranded glossary/ADR docs from dirty, untracked, ignored, and ahead-of-origin state; auto-lands one `docs:` PR through the ADR 0092 isolated lane when publishable, or halts before dispatch with the explicit file list when origin verification or landing fails.
