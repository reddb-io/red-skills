...
**What this wiki is about:** RedSkills, agents, skills, memory instrumentation, and engineering automation patterns

**Accepted source types:** URLs and markdown/local notes

**Voice:** Team voice: neutral and collective; avoid first-person personal notes unless quoting a source.
...
2. If file: copy markdown/text into `raw/<slug>.md`.
