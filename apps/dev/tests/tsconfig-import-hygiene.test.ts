...
const DEV_UNUSED_IMPORT_DEBT: Record<string, number> = {
  ...
  "src/commands/run/activity.ts": 131,
  "src/commands/run/command.ts": 74,
  "src/commands/run/flags.ts": 121,
  "src/commands/run/process-deps.ts": 69,
  "src/commands/run/reconcile.ts": 96,
  "src/commands/run/state.ts": 117,
  "src/commands/statusline.ts": 1,
  "src/commands/stop.ts": 5,
  "src/core/dashboard.ts": 1,
  "src/core/process-issue/lifecycle.ts": 62,
  "src/core/process-issue/recovery.ts": 92,
  "src/core/process-issue/terminal.ts": 77,
