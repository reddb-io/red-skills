...
// it, and the ratchet (`apps/dev/tests/domain-vocabulary-guard.test.ts`) sweeps
...
export const DOMAIN_VOCABULARY_ALLOWANCES: readonly DomainVocabularyAllowance[] = [
  {
    path: "apps/dev/src/core/domain-vocabulary-guard.ts",
    term: "Castle resident",
    kind: "historical",
  ...
  {
    path: "apps/dev/src/core/extinct-execution-chain.ts",
    term: "Castle resident",
    kind: "historical",
  ...
  {
    path: "apps/dev/src/core/extinct-source-guard.ts",
    term: "Demand producer",
    kind: "historical",
  ...
  {
    path: "apps/dev/src/mcp-tools/extinct-nouns.ts",
    term: "Demand producer",
    kind: "historical",
    reason: "the refusal an operator reads must say which noun was removed and what replaced it",
  },
  {
    path: "apps/dev/src/runtime/redskilled-birth.ts",
    term: "Demand producer",
    kind: "historical",
