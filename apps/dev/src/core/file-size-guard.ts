...
export const FILE_SIZE_BASELINE: readonly FileSizeBaselineEntry[] = [
  ...
  { path: "apps/dev/src/core/process-issue/lifecycle.ts", lines: 2240 },
  { path: "apps/dev/src/core/process-issue/terminal.ts", lines: 1308 },
  ...
  { path: "apps/dev/tests/process-issue.test-helpers.ts", lines: 966 },
